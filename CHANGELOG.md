...
## [17.5.0](https://github.com/jarmex/codecompanion.nvim/compare/v17.30.0...v17.5.0) (2025-11-04)


### ⚠ BREAKING CHANGES

* remove support for nvim-0.10 ([#1639](https://github.com/jarmex/codecompanion.nvim/issues/1639))
* **chat:** move the `goto_file_action` to `strategies.chat.opts`
* **chat:** move `opts.goto_file_action` to `strategies.chat.opts` ([#1571](https://github.com/jarmex/codecompanion.nvim/issues/1571))
* **chat:** reuse existing tabs when jumping to a file. ([#1569](https://github.com/jarmex/codecompanion.nvim/issues/1569))

### Features

* **acp:** add codex support ([#2236](https://github.com/jarmex/codecompanion.nvim/issues/2236)) ([2f7a088](https://github.com/jarmex/codecompanion.nvim/commit/2f7a08813914e07c7f1928128314aa1b27c40770))
* **acp:** add session modes ([#2331](https://github.com/jarmex/codecompanion.nvim/issues/2331)) ([1d98b9e](https://github.com/jarmex/codecompanion.nvim/commit/1d98b9e91107898b055ea54b4f24dad9a24d84ed))
* **acp:** add support for Claude Code ([#2079](https://github.com/jarmex/codecompanion.nvim/issues/2079)) ([0e4abfb](https://github.com/jarmex/codecompanion.nvim/commit/0e4abfb558f95fea9804a4239447c3f9a71013d2))
* **acp:** add support for slash commands ([#2260](https://github.com/jarmex/codecompanion.nvim/issues/2260)) ([b47e2aa](https://github.com/jarmex/codecompanion.nvim/commit/b47e2aa0873a5ea9ec96685a6e462599d8b823a4))
* **acp:** tighter integration with the protocol ([#2054](https://github.com/jarmex/codecompanion.nvim/issues/2054)) ([626b1b0](https://github.com/jarmex/codecompanion.nvim/commit/626b1b07e96e19324e5bb3279ab3b525a6ea759d))
* **action_palette:** title is configurable ([#1937](https://github.com/jarmex/codecompanion.nvim/issues/1937)) ([f3b1ff0](https://github.com/jarmex/codecompanion.nvim/commit/f3b1ff08e458708b51de4c7abf1be4ad5d25242a))
* **adapters:** :boom: add tool support to Ollama ([#1585](https://github.com/jarmex/codecompanion.nvim/issues/1585)) ([e325370](https://github.com/jarmex/codecompanion.nvim/commit/e325370b8325697cb2f6becd13f267e6a12a0393))
* **adapters:** add function calling to Novita ([#1888](https://github.com/jarmex/codecompanion.nvim/issues/1888)) ([c6fcb28](https://github.com/jarmex/codecompanion.nvim/commit/c6fcb28a69f0ceb5ee43922a8aadc7c663942246))
* **adapters:** add gemini-2.5-flash and set as new default ([#1686](https://github.com/jarmex/codecompanion.nvim/issues/1686)) ([fb98d6c](https://github.com/jarmex/codecompanion.nvim/commit/fb98d6c03f6039939e676f1257c76d8480a3da4f))
* **adapters:** add gemini-2.5-pro-preview-06-05 ([#1605](https://github.com/jarmex/codecompanion.nvim/issues/1605)) ([fa8af3b](https://github.com/jarmex/codecompanion.nvim/commit/fa8af3bbaa70773a5d104ad8fdc567d30be260b4))
* **adapters:** add new Anthropic models ([#1488](https://github.com/jarmex/codecompanion.nvim/issues/1488)) ([70d52e0](https://github.com/jarmex/codecompanion.nvim/commit/70d52e00c23a6df9ccf3bc927e2658b320764302))
* **adapters:** add support for Claude Sonnet 4.5 ([#2207](https://github.com/jarmex/codecompanion.nvim/issues/2207)) ([e629759](https://github.com/jarmex/codecompanion.nvim/commit/e629759ae6960418244f90b037f584323b3bc05c))
* **adapters:** add support for OpenAI's Responses API ([#2213](https://github.com/jarmex/codecompanion.nvim/issues/2213)) ([a3e55ba](https://github.com/jarmex/codecompanion.nvim/commit/a3e55baea86cc961fd4a172384d05c2f2d4c1446))
* **adapters:** add tool support to Azure OpenAI ([#1737](https://github.com/jarmex/codecompanion.nvim/issues/1737)) ([2c7e9b1](https://github.com/jarmex/codecompanion.nvim/commit/2c7e9b1aa9fa1f5a2b4d82f3f4e065cb0c8bc2b7))
* **adapters:** add tool support to HuggingFace ([#1907](https://github.com/jarmex/codecompanion.nvim/issues/1907)) ([afa34eb](https://github.com/jarmex/codecompanion.nvim/commit/afa34ebe3c48d74dc7e1c8b26d74f7f3a02cb531))
* **adapters:** add tool support to Mistral ([#2278](https://github.com/jarmex/codecompanion.nvim/issues/2278)) ([2a2b294](https://github.com/jarmex/codecompanion.nvim/commit/2a2b29410ddb4c2a5f72a2629c2180130ed9d4bb))
* **adapters:** add verbosity param to OpenAI Responses ([#2243](https://github.com/jarmex/codecompanion.nvim/issues/2243)) ([94f9120](https://github.com/jarmex/codecompanion.nvim/commit/94f9120387aa80832c4f164f60a6804a27b9479c))
* **adapters:** add vision support ([#1455](https://github.com/jarmex/codecompanion.nvim/issues/1455)) ([1a4f0a4](https://github.com/jarmex/codecompanion.nvim/commit/1a4f0a44b1e52d1c569ce2f66b03b6804e74b183))
* **adapters:** allow hiding of acp adapters ([#2086](https://github.com/jarmex/codecompanion.nvim/issues/2086)) ([aa7c937](https://github.com/jarmex/codecompanion.nvim/commit/aa7c937ac9f73e061da74dec6ab5f1fc6909dd37))
* **adapters:** can use adapter.opts.request to override Client:request ([#1469](https://github.com/jarmex/codecompanion.nvim/issues/1469)) ([ec73b64](https://github.com/jarmex/codecompanion.nvim/commit/ec73b64df3d0767eb0a5b42d942f9e02970ee95c))
* **adapters:** new copilot default is gpt-4.1 ([#1540](https://github.com/jarmex/codecompanion.nvim/issues/1540)) ([15b0614](https://github.com/jarmex/codecompanion.nvim/commit/15b06141cb9d66ebb3b3038fbe4fa9cd0ee0fc15))
* **adapters:** Ollama adapter has support for `think` and more hyperparameters ([#1829](https://github.com/jarmex/codecompanion.nvim/issues/1829)) ([408b402](https://github.com/jarmex/codecompanion.nvim/commit/408b402da023ae41f13b4a071e4c79d3b0b78693))
* **adapters:** support Copilot enterprise ([#1533](https://github.com/jarmex/codecompanion.nvim/issues/1533)) ([7572e35](https://github.com/jarmex/codecompanion.nvim/commit/7572e35f22395ad2ab095e75b419a70a00ca2036))
* **adapter:** support for OpenAI gpt-5 models ([#1993](https://github.com/jarmex/codecompanion.nvim/issues/1993)) ([69d7579](https://github.com/jarmex/codecompanion.nvim/commit/69d75795d82bc7d1ff77cf4461d59104b432c740))
* **adapters:** users can specify models for strategies ([#1518](https://github.com/jarmex/codecompanion.nvim/issues/1518)) ([763c81b](https://github.com/jarmex/codecompanion.nvim/commit/763c81b4823af3e3ef9cfb3f55f15f7f8f8b4b15))
* add chat ID to chat opened/hidden events ([17f7cbb](https://github.com/jarmex/codecompanion.nvim/commit/17f7cbb6cabdc12195f164acf4c59c7c7c205b64))
* add sonnet-4-5 ([e629759](https://github.com/jarmex/codecompanion.nvim/commit/e629759ae6960418244f90b037f584323b3bc05c))
* **chat:** :sparkles: add memory ([#2093](https://github.com/jarmex/codecompanion.nvim/issues/2093)) ([b3fe1b0](https://github.com/jarmex/codecompanion.nvim/commit/b3fe1b020262ef970e9bcd43f0faec856a5bd472))
* **chat:** add `CodeCompanionChatDone` event ([#1881](https://github.com/jarmex/codecompanion.nvim/issues/1881)) ([e23e8e5](https://github.com/jarmex/codecompanion.nvim/commit/e23e8e5a5643b089607f21f576f6e63174cc44dc))
* **chat:** add `collapse_tools` setting for tool groups ([#1614](https://github.com/jarmex/codecompanion.nvim/issues/1614)) ([f1442c7](https://github.com/jarmex/codecompanion.nvim/commit/f1442c743f0f40132d07b42ccf99e450b648fcf6))
* **chat:** add copilot usage statistics with `gS` keymap ([#1677](https://github.com/jarmex/codecompanion.nvim/issues/1677)) ([8602a50](https://github.com/jarmex/codecompanion.nvim/commit/8602a50cacf111c69f35e305d1556afd9fa1f1a1))
* **chat:** add floating diff layout with focus effects ([#2016](https://github.com/jarmex/codecompanion.nvim/issues/2016)) ([d556e1b](https://github.com/jarmex/codecompanion.nvim/commit/d556e1b2c0ac85037a589ae15dae461255297bc1))
* **chat:** add global metadata ([#1973](https://github.com/jarmex/codecompanion.nvim/issues/1973)) ([f962b2e](https://github.com/jarmex/codecompanion.nvim/commit/f962b2e33ffd9dfa91641fe21af648436a016906))
* **chat:** add keymap to jump to file under cursor ([#1408](https://github.com/jarmex/codecompanion.nvim/issues/1408)) ([4c54348](https://github.com/jarmex/codecompanion.nvim/commit/4c5434883fff08bc9814fb71aff0f51518276acb))
* **chat:** add restore function to ensure a chat buffer can be made visible ([#1816](https://github.com/jarmex/codecompanion.nvim/issues/1816)) ([f37b8b9](https://github.com/jarmex/codecompanion.nvim/commit/f37b8b91d77745b5e5fc816272f50b9826ada6d9))
* **chat:** add support for Agent Client Protocol ([#2025](https://github.com/jarmex/codecompanion.nvim/issues/2025)) ([ad468b1](https://github.com/jarmex/codecompanion.nvim/commit/ad468b141918af8a5da9d98fcd15a985e0139c76))
* **chat:** add support for Agent Client Protocol ([#2025](https://github.com/jarmex/codecompanion.nvim/issues/2025)) ([c71f51f](https://github.com/jarmex/codecompanion.nvim/commit/c71f51f0c4b35f2c35ed0c2f1a4d911f56e55866))
* **chat:** better tool cancelling ([#2153](https://github.com/jarmex/codecompanion.nvim/issues/2153)) ([119bd84](https://github.com/jarmex/codecompanion.nvim/commit/119bd84413611380045994d6ab5c2e077ed546c5)), closes [#2149](https://github.com/jarmex/codecompanion.nvim/issues/2149)
* **chat:** can preload with `default_tools` ([#1610](https://github.com/jarmex/codecompanion.nvim/issues/1610)) ([68c12a0](https://github.com/jarmex/codecompanion.nvim/commit/68c12a03a738aaeffe429c45b9f0c14ce00b0132))
* **chat:** can set default params for variables ([#1516](https://github.com/jarmex/codecompanion.nvim/issues/1516)) ([c0549d5](https://github.com/jarmex/codecompanion.nvim/commit/c0549d54203160020b4214d3e8827b2103a95b97))
* **chat:** chat buffer acts more like a normal buffer ([#1556](https://github.com/jarmex/codecompanion.nvim/issues/1556)) ([ebcdd78](https://github.com/jarmex/codecompanion.nvim/commit/ebcdd78a9d5d0d95c64fe9a106999b9f9603d2f3))
* **chat:** context can be folded in the chat buffer ([#1911](https://github.com/jarmex/codecompanion.nvim/issues/1911)) ([acfa69b](https://github.com/jarmex/codecompanion.nvim/commit/acfa69b6f712035dfc24c1aa2da3c8e5094e1699))
* **chat:** handle buffer deletion of chat buffers ([#1745](https://github.com/jarmex/codecompanion.nvim/issues/1745)) ([dbc7957](https://github.com/jarmex/codecompanion.nvim/commit/dbc7957ee92ddce403405c5c6d91ba7dccb278c7))
* **chat:** improve buffer variables ([#1967](https://github.com/jarmex/codecompanion.nvim/issues/1967)) ([5d2f49a](https://github.com/jarmex/codecompanion.nvim/commit/5d2f49a770c41fa26cb9200c592f0dca7af8d5a2))
* **chat:** remember cursor position when toggling ([#1523](https://github.com/jarmex/codecompanion.nvim/issues/1523)) ([51fb1df](https://github.com/jarmex/codecompanion.nvim/commit/51fb1dfa7227ace2e6635c8fcc75cc2ab1b607c6))
* **chat:** reuse existing tabs when jumping to a file. ([#1569](https://github.com/jarmex/codecompanion.nvim/issues/1569)) ([8747d88](https://github.com/jarmex/codecompanion.nvim/commit/8747d8871e310942996431d5374001a8b29ab0b7))
* **chat:** simplify watchers to use unified diffs ([#1583](https://github.com/jarmex/codecompanion.nvim/issues/1583)) ([81b817b](https://github.com/jarmex/codecompanion.nvim/commit/81b817b4186f85d4b2880516054b0e34bb27e60d))
* **chat:** support `:map-arguments` in keymaps ([#1572](https://github.com/jarmex/codecompanion.nvim/issues/1572)) ([d8e94cf](https://github.com/jarmex/codecompanion.nvim/commit/d8e94cfff7525ff5fdcc376093666c2cf57bb0e5))
* **chat:** support `pre_hook` in prompt library items ([#1964](https://github.com/jarmex/codecompanion.nvim/issues/1964)) ([8b60fcc](https://github.com/jarmex/codecompanion.nvim/commit/8b60fcc972ae08604505c4626b0e885e3d7396bf))
* **chat:** system prompt has improved knowledge ([#2038](https://github.com/jarmex/codecompanion.nvim/issues/2038)) ([32ebe36](https://github.com/jarmex/codecompanion.nvim/commit/32ebe36019b224d41943f2535bb306dce78144f9))
* **chat:** system prompt has improved knowledge ([#2038](https://github.com/jarmex/codecompanion.nvim/issues/2038)) ([71eb108](https://github.com/jarmex/codecompanion.nvim/commit/71eb108af3157fb268dda9bb6a0d762314bb70a2))
* **chat:** system prompt is modularised ([#2322](https://github.com/jarmex/codecompanion.nvim/issues/2322)) ([50ea30e](https://github.com/jarmex/codecompanion.nvim/commit/50ea30ec76e1a2695164991a7480f0fa0662e9db))
* **chat:** tool output can be folded ([#1665](https://github.com/jarmex/codecompanion.nvim/issues/1665)) ([a87ebc7](https://github.com/jarmex/codecompanion.nvim/commit/a87ebc73ffc796bb5020cb083e2a5ef3c2c7e9bf))
* **diff:** native inline diff and super diff ([#1884](https://github.com/jarmex/codecompanion.nvim/issues/1884)) ([6bc36af](https://github.com/jarmex/codecompanion.nvim/commit/6bc36af3898d6ad3e813f0d19c7e32972731ef37))
* **inline:** multiple variables, better completion and `#{clipboard}` ([#1981](https://github.com/jarmex/codecompanion.nvim/issues/1981)) ([c5aa3c6](https://github.com/jarmex/codecompanion.nvim/commit/c5aa3c6231f861f2ab20c886e0776c5b2f43bbe8))
* **keymaps:** use `false` for disabling keymaps ([#2264](https://github.com/jarmex/codecompanion.nvim/issues/2264)) ([982f80f](https://github.com/jarmex/codecompanion.nvim/commit/982f80fa44117ebe5b19218bade76536d94119d4))
* **prompt_library:** can set adapter on workflows ([#2071](https://github.com/jarmex/codecompanion.nvim/issues/2071)) ([2bd4983](https://github.com/jarmex/codecompanion.nvim/commit/2bd49835b915f95ee533b6773cbfef175d6c29d7))
* **prompt_library:** custom prompts can add references ([#1384](https://github.com/jarmex/codecompanion.nvim/issues/1384)) ([3117350](https://github.com/jarmex/codecompanion.nvim/commit/31173502852f0d524e9e74e51255177f094c45e0))
* **prompts:** custom intro messages and no user prompt requirements ([#1927](https://github.com/jarmex/codecompanion.nvim/issues/1927)) ([17dc923](https://github.com/jarmex/codecompanion.nvim/commit/17dc923059ec1b793d9f881785571493adfca4de))
* **providers:** add coc.nvim ([#1421](https://github.com/jarmex/codecompanion.nvim/issues/1421)) ([c22d2a6](https://github.com/jarmex/codecompanion.nvim/commit/c22d2a675f76a97ede327a49baddec02ecd6f3f5))
* **slash_cmd:** workspaces can now take user prompts ([#2039](https://github.com/jarmex/codecompanion.nvim/issues/2039)) ([00d0105](https://github.com/jarmex/codecompanion.nvim/commit/00d0105e96ed4685b8bc5dd4ca1acfed1db7598c))
* **slash_cmd:** workspaces can now take user prompts ([#2039](https://github.com/jarmex/codecompanion.nvim/issues/2039)) ([529902d](https://github.com/jarmex/codecompanion.nvim/commit/529902da176f411052d3de00a315c7fe5c7d5bd3))
* **slash_command:** new `/quickfix` command ([#1600](https://github.com/jarmex/codecompanion.nvim/issues/1600)) ([6384dc0](https://github.com/jarmex/codecompanion.nvim/commit/6384dc0d5b150394403e5ab3bc89bfad301634ea))
* **slash_commands:** add Telescope provider for `/image` ([#1542](https://github.com/jarmex/codecompanion.nvim/issues/1542)) ([a12d3aa](https://github.com/jarmex/codecompanion.nvim/commit/a12d3aa9a0825ae72733fcffc646615bc3bee484))
* **slash_commands:** better caching and restoring of URLs ([#1491](https://github.com/jarmex/codecompanion.nvim/issues/1491)) ([d39890c](https://github.com/jarmex/codecompanion.nvim/commit/d39890cb432801cfe5b2a97104289e1cc4b9c415))
* **slash_commands:** for `/fetch` only show cache option if cached files exist ([#1582](https://github.com/jarmex/codecompanion.nvim/issues/1582)) ([f022807](https://github.com/jarmex/codecompanion.nvim/commit/f0228073aeb2b577425ace676c34654b2e1a308d))
* support an adapter's built-in tools ([#2307](https://github.com/jarmex/codecompanion.nvim/issues/2307)) ([462197a](https://github.com/jarmex/codecompanion.nvim/commit/462197a603817ef91471266e1476464803f65224))
* **tools:** :sparkles: new `insert_edit_into_file` tool ([#2219](https://github.com/jarmex/codecompanion.nvim/issues/2219)) ([a4f8505](https://github.com/jarmex/codecompanion.nvim/commit/a4f850591970d5ab4e51951b08ddb0c5c239b210))
* **tools:** `[@editor](https://github.com/editor)` tool merges with `[@insert](https://github.com/insert)_edit_into_file` ([#1586](https://github.com/jarmex/codecompanion.nvim/issues/1586)) ([bec6cd1](https://github.com/jarmex/codecompanion.nvim/commit/bec6cd124da650dc25472e03f4416cbe27574ef8))
* **tools:** `insert_edit_into_file` tool now saves the buffer ([#1813](https://github.com/jarmex/codecompanion.nvim/issues/1813)) ([f7c89b4](https://github.com/jarmex/codecompanion.nvim/commit/f7c89b4a17d040ba4288f60b08c138b8b94bde4a))
* **tools:** `web_search` tool can search specific sites ([#1741](https://github.com/jarmex/codecompanion.nvim/issues/1741)) ([6ef907f](https://github.com/jarmex/codecompanion.nvim/commit/6ef907fca6480dd11dc8f7a3048fec23f8a39b29))
* **tools:** add `[@next](https://github.com/next)_edit_suggestion` tool ([#1570](https://github.com/jarmex/codecompanion.nvim/issues/1570)) ([600e7b2](https://github.com/jarmex/codecompanion.nvim/commit/600e7b2d55816fa3b8103ef898aaaa31a224224f))
* **tools:** add `fetch_webpage` ([#1837](https://github.com/jarmex/codecompanion.nvim/issues/1837)) ([31fdc34](https://github.com/jarmex/codecompanion.nvim/commit/31fdc343e8aba7c3c1dcabbf13a1c7a6379d077b))
* **tools:** add `file_search` tool ([#1613](https://github.com/jarmex/codecompanion.nvim/issues/1613)) ([3582a2c](https://github.com/jarmex/codecompanion.nvim/commit/3582a2c465fe8900ad70e24877d48247abd608c9))
* **tools:** add `get_changed_files` tool ([#1777](https://github.com/jarmex/codecompanion.nvim/issues/1777)) ([ed5c493](https://github.com/jarmex/codecompanion.nvim/commit/ed5c493eaf54b10b56f1489fdeac3689cd583807))
* **tools:** add `grep_search` tool ([#1651](https://github.com/jarmex/codecompanion.nvim/issues/1651)) ([98eb86c](https://github.com/jarmex/codecompanion.nvim/commit/98eb86cd5e66aa0f2bc3c47eb699ea81c99b74db))
* **tools:** add `list_code_usages` tool ([#1696](https://github.com/jarmex/codecompanion.nvim/issues/1696)) ([16b51b0](https://github.com/jarmex/codecompanion.nvim/commit/16b51b016d3bb1200e8c9350c5ced97f481916fe))
* **tools:** add tavily adapter and `[@web](https://github.com/web)_search` tool ([#1279](https://github.com/jarmex/codecompanion.nvim/issues/1279)) ([a5a8701](https://github.com/jarmex/codecompanion.nvim/commit/a5a8701bf8814ff0ba9bf5f76b3a3deedf3e5f28))
* **tools:** auto_tool_mode now auto submits ([#1580](https://github.com/jarmex/codecompanion.nvim/issues/1580)) ([1b2ab64](https://github.com/jarmex/codecompanion.nvim/commit/1b2ab6445dac16908b2136bd7c071e4dcb7f38d6))
* **tools:** can be conditionally loaded ([#1647](https://github.com/jarmex/codecompanion.nvim/issues/1647)) ([40ba4fc](https://github.com/jarmex/codecompanion.nvim/commit/40ba4fc7e7749a089f23123593d9a6c85140fcfc))
* **tools:** can load tools via relative paths ([#1552](https://github.com/jarmex/codecompanion.nvim/issues/1552)) ([7991e53](https://github.com/jarmex/codecompanion.nvim/commit/7991e53c0270db489b94e1a26c0d1608aa2d6206))
* **tools:** can send rejection message and always approve/accept ([#2249](https://github.com/jarmex/codecompanion.nvim/issues/2249)) ([3e8ab76](https://github.com/jarmex/codecompanion.nvim/commit/3e8ab76992ccc918699e6779f2a889201b611b89))
* **tools:** improve auto-submit and turn on by default ([#1539](https://github.com/jarmex/codecompanion.nvim/issues/1539)) ([3388e15](https://github.com/jarmex/codecompanion.nvim/commit/3388e1562aaa6d6deab90e8ad141439ed2bcac2f))
* **tools:** tools have their own system prompt ([b316283](https://github.com/jarmex/codecompanion.nvim/commit/b316283d9a0bee7fe05b452f1f7414d168f1cc83))
* **ui:** chat buffer can be sticky when navigating tabs ([#1842](https://github.com/jarmex/codecompanion.nvim/issues/1842)) ([71fb6a8](https://github.com/jarmex/codecompanion.nvim/commit/71fb6a80894c584d23ea55d4e8d3448cbb04eeaf))
* **ui:** customize chat buffer window config when opening ([#1678](https://github.com/jarmex/codecompanion.nvim/issues/1678)) ([3a10ec9](https://github.com/jarmex/codecompanion.nvim/commit/3a10ec951a0285f149a6f76ba3cf544b3e4b7c63))
* **ui:** fold reasoning content ([#2020](https://github.com/jarmex/codecompanion.nvim/issues/2020)) ([ad52c4f](https://github.com/jarmex/codecompanion.nvim/commit/ad52c4f5ca409784cb0940c9d0a62b514382dfec))
* **ui:** fold reasoning content ([#2020](https://github.com/jarmex/codecompanion.nvim/issues/2020)) ([b7bab43](https://github.com/jarmex/codecompanion.nvim/commit/b7bab43133fcc8e7baaba62b8148ccda1c381f61))
* **ui:** snacks picker shows previews in action palette ([#2295](https://github.com/jarmex/codecompanion.nvim/issues/2295)) ([41305ff](https://github.com/jarmex/codecompanion.nvim/commit/41305ffa613f3d210ef5418da2ea42d9af29e181))
* **workflows:** can change adapter on each prompt ([#2146](https://github.com/jarmex/codecompanion.nvim/issues/2146)) ([8d55059](https://github.com/jarmex/codecompanion.nvim/commit/8d55059b63bcf53e8b4d3d0885c37b2282d6fa2d))
* **workspaces:** files can be opened as buffers ([#1708](https://github.com/jarmex/codecompanion.nvim/issues/1708)) ([2ea49ff](https://github.com/jarmex/codecompanion.nvim/commit/2ea49ff2063100757e71b0e327b7a32a1d566a9d))


### Bug Fixes

* **acp:** claude code command shouldn't need npx ([#2288](https://github.com/jarmex/codecompanion.nvim/issues/2288)) ([5734709](https://github.com/jarmex/codecompanion.nvim/commit/5734709a37ee6436597912893fb326a1891a9288)), closes [#2286](https://github.com/jarmex/codecompanion.nvim/issues/2286)
* **acp:** close all open connections on exit ([#2292](https://github.com/jarmex/codecompanion.nvim/issues/2292)) ([73ecd3a](https://github.com/jarmex/codecompanion.nvim/commit/73ecd3a67cba61744ea8e3194ef464054025573c)), closes [#2286](https://github.com/jarmex/codecompanion.nvim/issues/2286)
* **acp:** ensure jobs can be cancelled ([#2225](https://github.com/jarmex/codecompanion.nvim/issues/2225)) ([a61dfc1](https://github.com/jarmex/codecompanion.nvim/commit/a61dfc1b916f4fabe482a68d106b7876800b371b)), closes [#2223](https://github.com/jarmex/codecompanion.nvim/issues/2223)
* **acp:** fix claude always outputting tool content ([062126b](https://github.com/jarmex/codecompanion.nvim/commit/062126b178783834c4bccc871cb3b200cc5aa3b9))
* **acp:** fs/read_text_file returning empty string ([#2058](https://github.com/jarmex/codecompanion.nvim/issues/2058)) ([a50f547](https://github.com/jarmex/codecompanion.nvim/commit/a50f547b4e4b525ad781ef57577254d8a4e769fa))
* **acp:** handle adapter returning vim.NIL instead of lua:nil ([#2266](https://github.com/jarmex/codecompanion.nvim/issues/2266)) ([5efcc8f](https://github.com/jarmex/codecompanion.nvim/commit/5efcc8f401061caf022bc54392b1ad968717220e))
* **acp:** race condition during initialization ([#2300](https://github.com/jarmex/codecompanion.nvim/issues/2300)) ([bcd4f84](https://github.com/jarmex/codecompanion.nvim/commit/bcd4f84598342c08564740417ef6b2d7ce0b77bf))
* **action_palette:** mini_pick handles picker actions ([#1944](https://github.com/jarmex/codecompanion.nvim/issues/1944)) ([3d336e2](https://github.com/jarmex/codecompanion.nvim/commit/3d336e25a15ec7862403d674aacb31a20233c06b))
* **adapter:** copilot unauthorized token expired ([#1789](https://github.com/jarmex/codecompanion.nvim/issues/1789)) ([d455d71](https://github.com/jarmex/codecompanion.nvim/commit/d455d71f5887063b08da3fc3cd60548460f1c875))
* **adapters:** `gpt-5-nano` streaming error ([#2017](https://github.com/jarmex/codecompanion.nvim/issues/2017)) ([ad2f08c](https://github.com/jarmex/codecompanion.nvim/commit/ad2f08c5d401708c1bec3b7fb2f6e96132cb4efb))
* **adapters:** copilot now supporting completions endpoint ([#2284](https://github.com/jarmex/codecompanion.nvim/issues/2284)) ([9741526](https://github.com/jarmex/codecompanion.nvim/commit/9741526b5efa8f1f313c8d41bbd7f1862c7d75d5))
* **adapters:** copilot return endpoints from github token ([#2078](https://github.com/jarmex/codecompanion.nvim/issues/2078)) ([19eb675](https://github.com/jarmex/codecompanion.nvim/commit/19eb6754df40ef54e2af0026b0d1916f2989df36))
* **adapters:** enable OpenAI vision support ([#1486](https://github.com/jarmex/codecompanion.nvim/issues/1486)) ([f8e14ae](https://github.com/jarmex/codecompanion.nvim/commit/f8e14ae0be51c0f65b0284f787277407db30ace7))
* **adapters:** fix claude-code always outputting tool content ([#2169](https://github.com/jarmex/codecompanion.nvim/issues/2169)) ([062126b](https://github.com/jarmex/codecompanion.nvim/commit/062126b178783834c4bccc871cb3b200cc5aa3b9))
* **adapters:** fix streaming for gemini adapter ([#1561](https://github.com/jarmex/codecompanion.nvim/issues/1561)) ([585fade](https://github.com/jarmex/codecompanion.nvim/commit/585fadef1940a66216124bdbd1bace55be3b1e73))
* **adapters:** handle choices as function in reasoning for OpenAI ([#1902](https://github.com/jarmex/codecompanion.nvim/issues/1902)) ([ea99a1b](https://github.com/jarmex/codecompanion.nvim/commit/ea99a1b4b341286df9d39dfe101c649bf868d39b))
* **adapters:** inline output for `openai_responses` adapter ([#2256](https://github.com/jarmex/codecompanion.nvim/issues/2256)) ([4437cb0](https://github.com/jarmex/codecompanion.nvim/commit/4437cb033ea2245981a9c55c268dd1fd5b710c61)), closes [#2252](https://github.com/jarmex/codecompanion.nvim/issues/2252)
* **adapters:** missing models in copilot ([#1899](https://github.com/jarmex/codecompanion.nvim/issues/1899)) ([30f7cc7](https://github.com/jarmex/codecompanion.nvim/commit/30f7cc7b768f4f0e694c1841e316d0cda91d7323))
* **adapters:** ollama model selection when changing adapter ([#1890](https://github.com/jarmex/codecompanion.nvim/issues/1890)) ([2695b92](https://github.com/jarmex/codecompanion.nvim/commit/2695b9221ba45071d7aefee49ad20880278e2344))
* **adapters:** ollama reasoning output ([#1950](https://github.com/jarmex/codecompanion.nvim/issues/1950)) ([940159d](https://github.com/jarmex/codecompanion.nvim/commit/940159de970105f9499f4b7e6dc980a70f50ba9e))
* **adapters:** reasoning output and tool calls in anthropic ([#1807](https://github.com/jarmex/codecompanion.nvim/issues/1807)) ([5717527](https://github.com/jarmex/codecompanion.nvim/commit/5717527ba6b1086ed748dd3b1390d0f431ec46cb)), closes [#1752](https://github.com/jarmex/codecompanion.nvim/issues/1752)
* **adapters:** reduce copilot premium request consumption ([#1738](https://github.com/jarmex/codecompanion.nvim/issues/1738)) ([ed96fe3](https://github.com/jarmex/codecompanion.nvim/commit/ed96fe33c17b41957f2334b1cae29c24d35f8ef2))
* **adapters:** resolving adapters from prompt library ([#1536](https://github.com/jarmex/codecompanion.nvim/issues/1536)) ([9964f48](https://github.com/jarmex/codecompanion.nvim/commit/9964f4880c66376e4c9f0d45f5fd2ab1e5496254)), closes [#1521](https://github.com/jarmex/codecompanion.nvim/issues/1521)
* **adapters:** update HuggingFace endpoint ([#1868](https://github.com/jarmex/codecompanion.nvim/issues/1868)) ([d067c84](https://github.com/jarmex/codecompanion.nvim/commit/d067c846d4f7239c6d3524ea3535f459b18dfd99)), closes [#1864](https://github.com/jarmex/codecompanion.nvim/issues/1864)
* **anthropic:** make sure empty tool calls are dictionaries. ([53b0671](https://github.com/jarmex/codecompanion.nvim/commit/53b0671d0cefc6d91148904e99d080ee4cd303e5))
* **chat:** `after/ftplugin/codecompanion.lua` settings now work ([#2251](https://github.com/jarmex/codecompanion.nvim/issues/2251)) ([87a2f78](https://github.com/jarmex/codecompanion.nvim/commit/87a2f78767a03707fa85f108d374a320ff000f02))
* **chat:** buffer var with no context ([#1974](https://github.com/jarmex/codecompanion.nvim/issues/1974)) ([0bfe9e2](https://github.com/jarmex/codecompanion.nvim/commit/0bfe9e2be02d3f396ad66c8e8995e0581f4ef65b))
* **chat:** claude code diff and fs/read_text_file fixes ([#2126](https://github.com/jarmex/codecompanion.nvim/issues/2126)) ([b76621b](https://github.com/jarmex/codecompanion.nvim/commit/b76621b1ced981f0ea358b9515e93bf86bb5acb5))
* **chat:** clip claude code tool output ([#2134](https://github.com/jarmex/codecompanion.nvim/issues/2134)) ([b890561](https://github.com/jarmex/codecompanion.nvim/commit/b8905612ccb08d6b4b166dd2508a458c33db7c84))
* **chat:** codeblock formatting in chat buffer ([#1916](https://github.com/jarmex/codecompanion.nvim/issues/1916)) ([3d4d85f](https://github.com/jarmex/codecompanion.nvim/commit/3d4d85f03acc3a31ea2ec9bd34db5194ed7696ff))
* **chat:** conditionals for slash commands and tools ([#2336](https://github.com/jarmex/codecompanion.nvim/issues/2336)) ([8719211](https://github.com/jarmex/codecompanion.nvim/commit/8719211b896c48ffd9c288efaf0d4a47fb17cd71))
* **chat:** correct yank command syntax in keymaps ([#1568](https://github.com/jarmex/codecompanion.nvim/issues/1568)) ([05555a4](https://github.com/jarmex/codecompanion.nvim/commit/05555a40f263488592556c3acfb61ef323805136))
* **chat:** debug window error with ACP adapters ([#2291](https://github.com/jarmex/codecompanion.nvim/issues/2291)) ([43586ed](https://github.com/jarmex/codecompanion.nvim/commit/43586ed845489f052469bdbc2bbdc3b7f13587b6))
* **chat:** debug window with acp adapters ([#2141](https://github.com/jarmex/codecompanion.nvim/issues/2141)) ([35c591f](https://github.com/jarmex/codecompanion.nvim/commit/35c591f457895f28f244684fa7e744fa3c9438c0))
* **chat:** default completions and add omnifunc ([#1953](https://github.com/jarmex/codecompanion.nvim/issues/1953)) ([bf69033](https://github.com/jarmex/codecompanion.nvim/commit/bf690335d0c6f1370b76a3b0b19c7a8afa3014c1))
* **chat:** default system prompt uses safer date format ([#2091](https://github.com/jarmex/codecompanion.nvim/issues/2091)) ([f97108b](https://github.com/jarmex/codecompanion.nvim/commit/f97108b9e9b13fe5df7e7e00fb1612ecb56aac34))
* **chat:** don't add duplicate memory ([#2131](https://github.com/jarmex/codecompanion.nvim/issues/2131)) ([669bbdf](https://github.com/jarmex/codecompanion.nvim/commit/669bbdf0940029a08074292d1f31f945af18d0cf))
* **chat:** don't cache blink completions ([#1618](https://github.com/jarmex/codecompanion.nvim/issues/1618)) ([8a958a4](https://github.com/jarmex/codecompanion.nvim/commit/8a958a4a1a11e58f1eb30d378c4c88c611d388d4))
* **chat:** don't remove custom system prompts when using `gs` ([#1770](https://github.com/jarmex/codecompanion.nvim/issues/1770)) ([4e75c62](https://github.com/jarmex/codecompanion.nvim/commit/4e75c629d1c1658c9330a75fd2ffec9cad59ed50)), closes [#1749](https://github.com/jarmex/codecompanion.nvim/issues/1749)
* **chat:** force memory to be added via slash command ([#2140](https://github.com/jarmex/codecompanion.nvim/issues/2140)) ([8899c27](https://github.com/jarmex/codecompanion.nvim/commit/8899c278c2e34108aec573b5f782a6bb7915d83c))
* **chat:** infinite loop when toggling chat ([#2145](https://github.com/jarmex/codecompanion.nvim/issues/2145)) ([30fec3a](https://github.com/jarmex/codecompanion.nvim/commit/30fec3a084832d89cddb8d45827ff061e3564993))
* **chat:** omnifunc completion ([#2275](https://github.com/jarmex/codecompanion.nvim/issues/2275)) ([b1937ad](https://github.com/jarmex/codecompanion.nvim/commit/b1937ad400305860558c0adf6bd10ae7892fff26)), closes [#2270](https://github.com/jarmex/codecompanion.nvim/issues/2270)
* **chat:** pass in opts to toggle ([#2143](https://github.com/jarmex/codecompanion.nvim/issues/2143)) ([971e584](https://github.com/jarmex/codecompanion.nvim/commit/971e584c29ea04aca189188378a0c9b10a1c531b))
* **chat:** paths are always relative and wrap context in &lt;attachment&gt; ([#1633](https://github.com/jarmex/codecompanion.nvim/issues/1633)) ([2185ccc](https://github.com/jarmex/codecompanion.nvim/commit/2185ccc81eeb9080f6c856a408ed3cba3f2bb7ef)), closes [#1630](https://github.com/jarmex/codecompanion.nvim/issues/1630) [#1631](https://github.com/jarmex/codecompanion.nvim/issues/1631)
* **chat:** prevent duplicate # and @ in CoC completions ([#2027](https://github.com/jarmex/codecompanion.nvim/issues/2027)) ([7d9e142](https://github.com/jarmex/codecompanion.nvim/commit/7d9e142a768d3649518515d0827dd7b66c558965))
* **chat:** prevent duplicate # and @ in CoC completions ([#2027](https://github.com/jarmex/codecompanion.nvim/issues/2027)) ([adb3126](https://github.com/jarmex/codecompanion.nvim/commit/adb312667a55fe59a559fd6cf16ecd17b6db6914))
* **chat:** prevent readfile error on directories when using edit_tracker ([#2269](https://github.com/jarmex/codecompanion.nvim/issues/2269)) ([9d49b75](https://github.com/jarmex/codecompanion.nvim/commit/9d49b758de4a3f2c4c2e8a0561e6d126e47dad85))
* **chat:** recursive chat open calls ([59a29bd](https://github.com/jarmex/codecompanion.nvim/commit/59a29bd5aea9d82489b13405895b0eead990c49b))
* **chat:** Register cmp completions when filetype is set ([#1560](https://github.com/jarmex/codecompanion.nvim/issues/1560)) ([3d62ac3](https://github.com/jarmex/codecompanion.nvim/commit/3d62ac3ebe840245b157e169d06b8d87ee878dc5))
* **chat:** safely set undolevels ([#2123](https://github.com/jarmex/codecompanion.nvim/issues/2123)) ([5807e04](https://github.com/jarmex/codecompanion.nvim/commit/5807e0457111f0de267fc9a6543b41fae0f5c2b1))
* **chat:** show settings error with acp adapter ([#2065](https://github.com/jarmex/codecompanion.nvim/issues/2065)) ([bf683c3](https://github.com/jarmex/codecompanion.nvim/commit/bf683c3ea033a12f58b3534d5969cec4c29b2602)), closes [#2062](https://github.com/jarmex/codecompanion.nvim/issues/2062)
* **chat:** start_in_insert_mode with telescope ([#1815](https://github.com/jarmex/codecompanion.nvim/issues/1815)) ([dc5eca1](https://github.com/jarmex/codecompanion.nvim/commit/dc5eca177248f5d77e7d01fdd98e18f90ecfcc56))
* **chat:** system prompt resolving ([#2045](https://github.com/jarmex/codecompanion.nvim/issues/2045)) ([c34e496](https://github.com/jarmex/codecompanion.nvim/commit/c34e49676dd9bd44c9a18588167cdc0a31077dbd))
* **chat:** toggling when chat buffer is not in the current tab ([#1725](https://github.com/jarmex/codecompanion.nvim/issues/1725)) ([4f91b4b](https://github.com/jarmex/codecompanion.nvim/commit/4f91b4b6b400b97b923537cb75721b8452cd54dc))
* **chat:** tool folding ([#1811](https://github.com/jarmex/codecompanion.nvim/issues/1811)) ([b506225](https://github.com/jarmex/codecompanion.nvim/commit/b5062255224cb72ee35e374ac764ac53f6fe9fa1))
* **chat:** tools can now be dynamically added ([#1693](https://github.com/jarmex/codecompanion.nvim/issues/1693)) ([3a5f895](https://github.com/jarmex/codecompanion.nvim/commit/3a5f8958197b2e134e7d299673bff76c785dbc99))
* **chat:** undolevels leaking outside of codecompanion ([#2234](https://github.com/jarmex/codecompanion.nvim/issues/2234)) ([ebce7c7](https://github.com/jarmex/codecompanion.nvim/commit/ebce7c77585d421ca428233fb480c5e3a2873f50))
* **chat:** unwatch buffers when they're unlisted ([#1809](https://github.com/jarmex/codecompanion.nvim/issues/1809)) ([ea29e11](https://github.com/jarmex/codecompanion.nvim/commit/ea29e112916bad53e52f514bff1bc2e54e2287c2))
* **chat:** use file contents to detect filetype for symbols ([#1827](https://github.com/jarmex/codecompanion.nvim/issues/1827)) ([ee1c317](https://github.com/jarmex/codecompanion.nvim/commit/ee1c317d4ac468f8c5938d7e954e65cb037757e7))
* **chat:** watchers use the same diff format as in patch ([#1655](https://github.com/jarmex/codecompanion.nvim/issues/1655)) ([86b1ff1](https://github.com/jarmex/codecompanion.nvim/commit/86b1ff13d140d3b63f49f1cbfd69873b2cbbe40d))
* **chat:** word boundary matching for tools and variables ([#1503](https://github.com/jarmex/codecompanion.nvim/issues/1503)) ([f572601](https://github.com/jarmex/codecompanion.nvim/commit/f57260190a40bb4f071d27c5386eeff1440c111b))
* **diff:** fire detach when inline diff completes ([#2237](https://github.com/jarmex/codecompanion.nvim/issues/2237)) ([a189018](https://github.com/jarmex/codecompanion.nvim/commit/a189018721a692dabdefbf1e0f58971c6204a7d7))
* doubled # and @ in CoC completion ([7d9e142](https://github.com/jarmex/codecompanion.nvim/commit/7d9e142a768d3649518515d0827dd7b66c558965))
* doubled # and @ in CoC completion ([adb3126](https://github.com/jarmex/codecompanion.nvim/commit/adb312667a55fe59a559fd6cf16ecd17b6db6914))
* ensure buffer is valid ([#1985](https://github.com/jarmex/codecompanion.nvim/issues/1985)) ([ff248ec](https://github.com/jarmex/codecompanion.nvim/commit/ff248ec17cc1797883ac122e1b3d4a69492b541e)), closes [#1983](https://github.com/jarmex/codecompanion.nvim/issues/1983)
* **inline:** chat placements with claude-sonnet-4 ([#1636](https://github.com/jarmex/codecompanion.nvim/issues/1636)) ([0f82355](https://github.com/jarmex/codecompanion.nvim/commit/0f8235523ee555daa6acc6a5e5b5c4472ed60b43)), closes [#1626](https://github.com/jarmex/codecompanion.nvim/issues/1626)
* **inline:** Check result from vim.json.decode pcall ([#2101](https://github.com/jarmex/codecompanion.nvim/issues/2101)) ([d5f4070](https://github.com/jarmex/codecompanion.nvim/commit/d5f40701ca4299300e94910f35342beb47861bcf))
* **inline:** events are fired with the correct names ([#1919](https://github.com/jarmex/codecompanion.nvim/issues/1919)) ([18cf425](https://github.com/jarmex/codecompanion.nvim/commit/18cf425c837d6e3745b4872d5bf48a2be18b414e))
* **inline:** keymap modes ([#1468](https://github.com/jarmex/codecompanion.nvim/issues/1468)) ([7ac8234](https://github.com/jarmex/codecompanion.nvim/commit/7ac823450c490201af3362a0861c2c1c19b827a8))
* **inline:** parse adapters ([#2069](https://github.com/jarmex/codecompanion.nvim/issues/2069)) ([12c617a](https://github.com/jarmex/codecompanion.nvim/commit/12c617a969f53738f1126a389e8f72f4f754f6c0))
* **inline:** prompting using telescope and dressing in the UI ([#1702](https://github.com/jarmex/codecompanion.nvim/issues/1702)) ([50dde48](https://github.com/jarmex/codecompanion.nvim/commit/50dde48a6a078283c30ec177f7ab3c4eaa350341))
* **inline:** remove blank lines in diffs ([#1565](https://github.com/jarmex/codecompanion.nvim/issues/1565)) ([fee2dd1](https://github.com/jarmex/codecompanion.nvim/commit/fee2dd137b515b779c57c915ca031921e6591d85))
* **inline:** revert keymap changes ([#1622](https://github.com/jarmex/codecompanion.nvim/issues/1622)) ([6f89961](https://github.com/jarmex/codecompanion.nvim/commit/6f89961632defce5a591195851569758a1e15a0e)), closes [#1621](https://github.com/jarmex/codecompanion.nvim/issues/1621)
* **inline:** user moving to other buffer before edits are applied ([#1952](https://github.com/jarmex/codecompanion.nvim/issues/1952)) ([ddfb8cc](https://github.com/jarmex/codecompanion.nvim/commit/ddfb8cc91b4e80e5afb16e832c334d86040ff0c0))
* **inline:** variables ([#1955](https://github.com/jarmex/codecompanion.nvim/issues/1955)) ([4c1cd7e](https://github.com/jarmex/codecompanion.nvim/commit/4c1cd7e5612bc083234877cf3299bb740ee64112)), closes [#1954](https://github.com/jarmex/codecompanion.nvim/issues/1954)
* **prompt_library:** completion in the cmd line ([#1893](https://github.com/jarmex/codecompanion.nvim/issues/1893)) ([e8ab7ef](https://github.com/jarmex/codecompanion.nvim/commit/e8ab7eff9fb61dc7177a1d9bb830886eacbe3114))
* **prompt_library:** custom prompts containing URLs ([#1849](https://github.com/jarmex/codecompanion.nvim/issues/1849)) ([164e95c](https://github.com/jarmex/codecompanion.nvim/commit/164e95c6ff0becd6d152e06be56ccd98f53bc5a8))
* **prompt_library:** use vim.system for commit messages item ([#2315](https://github.com/jarmex/codecompanion.nvim/issues/2315)) ([ed9940f](https://github.com/jarmex/codecompanion.nvim/commit/ed9940fe10fab7b7181b43293c70d287ba5ef231))
* **prompts:** agentic workflow in the config ([#1764](https://github.com/jarmex/codecompanion.nvim/issues/1764)) ([0b3831d](https://github.com/jarmex/codecompanion.nvim/commit/0b3831ddee88a389aa663fb05e35f2724f6df7da))
* **prompts:** reword vectorcode tool in workspace prompt ([#1775](https://github.com/jarmex/codecompanion.nvim/issues/1775)) ([3527a9c](https://github.com/jarmex/codecompanion.nvim/commit/3527a9c85b58a8db2fee6d7dcde72077ba790a4a))
* **prompt:** tags renamed to be tag ([#2115](https://github.com/jarmex/codecompanion.nvim/issues/2115)) ([a869f19](https://github.com/jarmex/codecompanion.nvim/commit/a869f190f627123de8bf97df9e9b5bd6f61645f9))
* **providers:** only use `mini.diff` if initialized ([#1472](https://github.com/jarmex/codecompanion.nvim/issues/1472)) ([f7bb598](https://github.com/jarmex/codecompanion.nvim/commit/f7bb59888b201507a43c856460d455f786c989f8))
* **providers:** register coc execute function ([#1548](https://github.com/jarmex/codecompanion.nvim/issues/1548)) ([92ba84c](https://github.com/jarmex/codecompanion.nvim/commit/92ba84cddf19d936809d9775884699e66a070ec4))
* **references:** unlock buffer when adding reference after a tool output ([#1477](https://github.com/jarmex/codecompanion.nvim/issues/1477)) ([df44594](https://github.com/jarmex/codecompanion.nvim/commit/df4459401180612bc5b7b167eff7133324e85f1c))
* require tool module path correctly ([#1670](https://github.com/jarmex/codecompanion.nvim/issues/1670)) ([dbefc41](https://github.com/jarmex/codecompanion.nvim/commit/dbefc41dba2f46720ecb6ecec34c0c5f80022f2b))
* **slash_cmds:** fetching an image from a URL ([#2245](https://github.com/jarmex/codecompanion.nvim/issues/2245)) ([e16ebf5](https://github.com/jarmex/codecompanion.nvim/commit/e16ebf57e3cb09d5ee5e8c3c2acee84e6dc650b8)), closes [#2244](https://github.com/jarmex/codecompanion.nvim/issues/2244)
* **slash_commands:** update adapter reference ([#1502](https://github.com/jarmex/codecompanion.nvim/issues/1502)) ([41108b2](https://github.com/jarmex/codecompanion.nvim/commit/41108b2ee7d71eca50ff6c5008b30a853e14cf35))
* **snacks:** fix nested picking and add preview. ([41305ff](https://github.com/jarmex/codecompanion.nvim/commit/41305ffa613f3d210ef5418da2ea42d9af29e181))
* **super_diff:** align variable names with updated diff hunk naming ([#2218](https://github.com/jarmex/codecompanion.nvim/issues/2218)) ([0380600](https://github.com/jarmex/codecompanion.nvim/commit/03806002044f94f8789b28435efd6d383675ba87))
* **tools:** `cmd_runner` tool on Windows ([#2186](https://github.com/jarmex/codecompanion.nvim/issues/2186)) ([d5491dd](https://github.com/jarmex/codecompanion.nvim/commit/d5491dd9a1509c845c52276ad7d42cb5ff0ee550)), closes [#2179](https://github.com/jarmex/codecompanion.nvim/issues/2179)
* **tools:** `insert_edit_info_file` tool can insert at EOF ([#1650](https://github.com/jarmex/codecompanion.nvim/issues/1650)) ([d54a41a](https://github.com/jarmex/codecompanion.nvim/commit/d54a41a86a510e9c728f6e460801afdf581d69da))
* **tools:** `read_files` tool can read entire file if `end_line` is greater than total lines ([#1824](https://github.com/jarmex/codecompanion.nvim/issues/1824)) ([562950d](https://github.com/jarmex/codecompanion.nvim/commit/562950d1584a1ff603921ec7ce48638e2d7f9e1d))
* **tools:** additional resiliency ([#1987](https://github.com/jarmex/codecompanion.nvim/issues/1987)) ([bc5ec92](https://github.com/jarmex/codecompanion.nvim/commit/bc5ec92b5f4b8542150a6ae2e77422ec50f440a1))
* **tools:** auto submit sends updated buffer ([#1545](https://github.com/jarmex/codecompanion.nvim/issues/1545)) ([82f5917](https://github.com/jarmex/codecompanion.nvim/commit/82f5917455cb7156f36daa99b2ec8049a7958ce5))
* **tools:** enforce strict mode for openai responses adapter ([#2319](https://github.com/jarmex/codecompanion.nvim/issues/2319)) ([09e1b9f](https://github.com/jarmex/codecompanion.nvim/commit/09e1b9f3c22e77739bfbae7ddb9b97aa79f811be)), closes [#2314](https://github.com/jarmex/codecompanion.nvim/issues/2314)
* **tools:** ensure errors are handled throughout implementation ([#1986](https://github.com/jarmex/codecompanion.nvim/issues/1986)) ([705f0cf](https://github.com/jarmex/codecompanion.nvim/commit/705f0cf1d15dabd7db478c4ef751d86744726d2b)), closes [#1940](https://github.com/jarmex/codecompanion.nvim/issues/1940)
* **tools:** error when trying to log nil tool ([#1896](https://github.com/jarmex/codecompanion.nvim/issues/1896)) ([63ce32a](https://github.com/jarmex/codecompanion.nvim/commit/63ce32aa44135ba863aa1e5ed49a0abfdaeb926e))
* **tools:** failed/cancelled/rejected tool calls no longer block the execution queue ([#1852](https://github.com/jarmex/codecompanion.nvim/issues/1852)) ([48d7e8f](https://github.com/jarmex/codecompanion.nvim/commit/48d7e8f6b2fb894afd68e1475bf63d81c934239a)), closes [#1850](https://github.com/jarmex/codecompanion.nvim/issues/1850)
* **tools:** fetch webpage ([#2320](https://github.com/jarmex/codecompanion.nvim/issues/2320)) ([d13a74f](https://github.com/jarmex/codecompanion.nvim/commit/d13a74ff2954ca9d5e46f4f782e6dc67a95672c3)), closes [#2318](https://github.com/jarmex/codecompanion.nvim/issues/2318)
* **tools:** Handle empty parameters in tools ([ac70519](https://github.com/jarmex/codecompanion.nvim/commit/ac705198a1981316bb6cb461148326e3c8730da8))
* **tools:** list code usages tool ([#2019](https://github.com/jarmex/codecompanion.nvim/issues/2019)) ([31ffde8](https://github.com/jarmex/codecompanion.nvim/commit/31ffde8fc296432d866a877f25084558c78c1806)), closes [#2018](https://github.com/jarmex/codecompanion.nvim/issues/2018)
* **tools:** list code usages tool ([#2019](https://github.com/jarmex/codecompanion.nvim/issues/2019)) ([3c9224e](https://github.com/jarmex/codecompanion.nvim/commit/3c9224e3a0084d6c251b9f81d5cb3c6ac12878e6)), closes [#2018](https://github.com/jarmex/codecompanion.nvim/issues/2018)
* **tools:** make `insert_edit_into_file` more robust for patch markers ([#1653](https://github.com/jarmex/codecompanion.nvim/issues/1653)) ([a6e226c](https://github.com/jarmex/codecompanion.nvim/commit/a6e226ced63d9bb5e601213e63f5cd07ad09f7cd))
* **tools:** patching algorithm can start with an empty line ([#1663](https://github.com/jarmex/codecompanion.nvim/issues/1663)) ([370ec56](https://github.com/jarmex/codecompanion.nvim/commit/370ec56f388fd317fd324d68709e9441d3461896))
* **tools:** patching algorithm now supports lines starting with `-` ([#1654](https://github.com/jarmex/codecompanion.nvim/issues/1654)) ([9011839](https://github.com/jarmex/codecompanion.nvim/commit/9011839a6827b264d632822d9ce17cb66fe95e61))
* **tools:** patching for empty and small files with insufficient context ([#1734](https://github.com/jarmex/codecompanion.nvim/issues/1734)) ([cb55ef0](https://github.com/jarmex/codecompanion.nvim/commit/cb55ef006be3e75015c84fbd9adef14b3546a08f))
* **tools:** Support nested objects in enforce_strictness for OpenAI strict mode ([#2334](https://github.com/jarmex/codecompanion.nvim/issues/2334)) ([88ddc28](https://github.com/jarmex/codecompanion.nvim/commit/88ddc28101ca771f99b3ba7489b5abe831de9a17))
* **ui:** append to existing winhighlight values ([#2166](https://github.com/jarmex/codecompanion.nvim/issues/2166)) ([5c8ec88](https://github.com/jarmex/codecompanion.nvim/commit/5c8ec88568115c4091cca331c4cbc42888cb5dc7))
* **ui:** chat buffer syntax highlighting ([#2192](https://github.com/jarmex/codecompanion.nvim/issues/2192)) ([4336066](https://github.com/jarmex/codecompanion.nvim/commit/4336066619f08dd93b2c8900c542cbb6bac5f18a))
* **ui:** default to normal mode after applying inline diff ([#2014](https://github.com/jarmex/codecompanion.nvim/issues/2014)) ([b75615a](https://github.com/jarmex/codecompanion.nvim/commit/b75615a3064685f02b837b591f648536904bb702))
* **ui:** display the correct `sign_text` in floating diffs ([#2031](https://github.com/jarmex/codecompanion.nvim/issues/2031)) ([54b9502](https://github.com/jarmex/codecompanion.nvim/commit/54b9502b796ee18b491f77f24af7209ec80d306a))
* **ui:** display the correct `sign_text` in floating diffs ([#2031](https://github.com/jarmex/codecompanion.nvim/issues/2031)) ([2f21f79](https://github.com/jarmex/codecompanion.nvim/commit/2f21f79fe1791ca4335aca90b4608f434c347855))
* **ui:** enable keymaps in debug chat float for easier quitting ([#1923](https://github.com/jarmex/codecompanion.nvim/issues/1923)) ([5e7d451](https://github.com/jarmex/codecompanion.nvim/commit/5e7d451098f61afdb13710844aaf0d83530e4128))
* **ui:** floating diff style ([#2035](https://github.com/jarmex/codecompanion.nvim/issues/2035)) ([483d0c0](https://github.com/jarmex/codecompanion.nvim/commit/483d0c0a91f0cad3ed2a1728d8c088c1b7e414ff))
* **ui:** floating diff style ([#2035](https://github.com/jarmex/codecompanion.nvim/issues/2035)) ([3e8188f](https://github.com/jarmex/codecompanion.nvim/commit/3e8188f87465c851b2e8f081f714928d6577675f))
* **ui:** handle custom winborder characters ([#1915](https://github.com/jarmex/codecompanion.nvim/issues/1915)) ([9e23ef1](https://github.com/jarmex/codecompanion.nvim/commit/9e23ef19429e17d68c0bda28c687b85b6741e666))
* **ui:** reduce delay in using `gr` to reject diff ([#1917](https://github.com/jarmex/codecompanion.nvim/issues/1917)) ([55c29d9](https://github.com/jarmex/codecompanion.nvim/commit/55c29d920380c5a83ca00902dd5d3c3dd22a9211))
* **ui:** snacks being completely ignored ([#2010](https://github.com/jarmex/codecompanion.nvim/issues/2010)) ([fed4a5d](https://github.com/jarmex/codecompanion.nvim/commit/fed4a5ddd79f92357a2320e4bcff0d56c46fc9b6)), closes [#2009](https://github.com/jarmex/codecompanion.nvim/issues/2009)
* **ui:** snacks being completely ignored ([#2010](https://github.com/jarmex/codecompanion.nvim/issues/2010)) ([b02a7da](https://github.com/jarmex/codecompanion.nvim/commit/b02a7da50e8d1ee473a31f79152dcdf8f7abf5d5)), closes [#2009](https://github.com/jarmex/codecompanion.nvim/issues/2009)
* **ui:** tool spacing in chat buffer ([#1962](https://github.com/jarmex/codecompanion.nvim/issues/1962)) ([a61730e](https://github.com/jarmex/codecompanion.nvim/commit/a61730e84f92453390a4e1250482033482c33e84))
* use correct config item ([#2195](https://github.com/jarmex/codecompanion.nvim/issues/2195)) ([7f28c3c](https://github.com/jarmex/codecompanion.nvim/commit/7f28c3cc3abb116f14281ed4f490929684ffb1e7))
* **utils:** fallback to vim.highlight ([#1611](https://github.com/jarmex/codecompanion.nvim/issues/1611)) ([6d62e18](https://github.com/jarmex/codecompanion.nvim/commit/6d62e1843cbee7a181a5b86de9e4ec554650d8d9))
* **variables:** ensure special chars are matched ([#1470](https://github.com/jarmex/codecompanion.nvim/issues/1470)) ([a682004](https://github.com/jarmex/codecompanion.nvim/commit/a682004d4ff97c0450617975699bfc78029862be))
* **workflows:** successive prompts and tools now work ([#1508](https://github.com/jarmex/codecompanion.nvim/issues/1508)) ([0112caf](https://github.com/jarmex/codecompanion.nvim/commit/0112caf54a79bb6cfbcb6e67cd16a3a9f18af9a7)), closes [#1496](https://github.com/jarmex/codecompanion.nvim/issues/1496)
* **workspace:** add description to buffer content ([#1713](https://github.com/jarmex/codecompanion.nvim/issues/1713)) ([ff939d1](https://github.com/jarmex/codecompanion.nvim/commit/ff939d18d8d64b0bef985aeb9be26f57e4ee8837))


### Performance Improvements

* **chat:** improve system prompt resolution ([#2050](https://github.com/jarmex/codecompanion.nvim/issues/2050)) ([6bc1f9f](https://github.com/jarmex/codecompanion.nvim/commit/6bc1f9f6d9f4ac71545b4883caf93181cadf6146))
* **chat:** set undolevels to 10 ([#2022](https://github.com/jarmex/codecompanion.nvim/issues/2022)) ([3cf980e](https://github.com/jarmex/codecompanion.nvim/commit/3cf980e36db2f7136079d73b927908cedd5863c6))
* **chat:** set undolevels to 10 ([#2022](https://github.com/jarmex/codecompanion.nvim/issues/2022)) ([94784eb](https://github.com/jarmex/codecompanion.nvim/commit/94784eb7050ad349870a0d0f2331fcd9d408d5cc))


### Code Refactoring

* **chat:** move `opts.goto_file_action` to `strategies.chat.opts` ([#1571](https://github.com/jarmex/codecompanion.nvim/issues/1571)) ([cdf7721](https://github.com/jarmex/codecompanion.nvim/commit/cdf772165782e55a451c0793bf4c2a89926b89bd))
* **chat:** move the `goto_file_action` to `strategies.chat.opts` ([cdf7721](https://github.com/jarmex/codecompanion.nvim/commit/cdf772165782e55a451c0793bf4c2a89926b89bd))
* **chat:** tools and variables now use `@{tool}` and `#{variable}` syntax ([#1740](https://github.com/jarmex/codecompanion.nvim/issues/1740)) ([f89eca2](https://github.com/jarmex/codecompanion.nvim/commit/f89eca26368b29bc8259921d459c1b4e5bfaeebb))
* remove support for nvim-0.10 ([#1639](https://github.com/jarmex/codecompanion.nvim/issues/1639)) ([5d0ef43](https://github.com/jarmex/codecompanion.nvim/commit/5d0ef43ed822ea3341ed0989e45f2d10d57ba359))
